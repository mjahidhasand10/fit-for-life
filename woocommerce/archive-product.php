            ...
            <aside class="lg:col-span-1">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm mb-6">
                    ...
                    <form method="GET" id="priceFilterForm">
                        ...
                        <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-lg uppercase tracking-wide text-sm transition-all duration-300 hover:shadow-lg">
                            Filter
                        </button>
                    </form>
                </div>
